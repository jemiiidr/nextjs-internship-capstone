				...
				<section id="analytics" className="px-4 py-24 sm:px-6 lg:px-8">
					<div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:items-center">
						<div>
							...
							<div className="mt-6 space-y-3 text-sm text-paynes_gray-600">
						...
						<div className="flowora-panel rounded-3xl border border-french_gray-300 bg-white p-6 dark:border-paynes_gray-800 dark:bg-outer_space-500">
				...
				>
					<div className="mx-auto max-w-7xl rounded-4xl bg-linear-to-r from-blue_munsell-500 via-[#b26fce] to-[#f29586] p-px">
						<div className="rounded-[calc(2rem-1px)] bg-white px-7 py-12 text-center dark:bg-outer_space-500 sm:px-12">
							...
							<p className="mx-auto mt-3 max-w-2xl text-paynes_gray-500">
