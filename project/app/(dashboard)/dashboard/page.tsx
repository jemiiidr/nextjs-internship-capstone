		...
		<div className="space-y-6">
			<header>
				...
				<p className="mt-2 text-paynes_gray-500 dark:text-french_gray-400">
					Here&apos;s what&apos;s moving in {workspace.name}.
				</p>
			</header>
			<DashboardOverview
				stats={{ ...data.stats, dueSoon }}
				analytics={analytics}
				tasks={myTasks}
