...
export function Hero() {
	return (
		<section className="flowora-soft-gradient relative overflow-hidden px-4 pb-24 pt-20 sm:px-6 sm:pt-28 lg:px-8">
			<div
				className="absolute inset-0 bg-[linear-gradient(to_right,color-mix(in_srgb,var(--border)_45%,transparent)_1px,transparent_1px),linear-gradient(to_bottom,color-mix(in_srgb,var(--border)_45%,transparent)_1px,transparent_1px)] bg-[size:64px_64px] opacity-45 [mask-image:linear-gradient(to_bottom,black,transparent_75%)]"
				aria-hidden="true"
			/>
			...
			<Parallax
				distance={34}
				className="relative mx-auto mt-14 max-w-6xl rounded-[2rem] border border-white/80 bg-white/80 p-3 shadow-[0_30px_80px_rgba(31,38,64,.12)] backdrop-blur dark:border-paynes_gray-800 dark:bg-outer_space-500/80 dark:shadow-[0_30px_90px_rgba(0,0,0,.28)]"
			>
