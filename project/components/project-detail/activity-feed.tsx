...
import { formatActivityCopy, formatRelativeDate } from "@/lib/utils";
	...
	return (
		<>
			...
			<Modal
				...
				description="A chronological history of changes to this project."
				className="max-w-2xl"
			>
				<div className="min-h-96">
					<div className="divide-y divide-french_gray-200 dark:divide-paynes_gray-800">
						{activities.slice((page - 1) * pageSize, page * pageSize).map(row)}
					</div>
					{!activities.length ? (
						<p className="py-16 text-center text-sm text-paynes_gray-500">
							No activity records yet.
						</p>
					) : null}
				</div>
				<div className="mt-4 flex items-center justify-between border-t border-french_gray-200 pt-4 dark:border-paynes_gray-800">
